  ...
  ({
    ...
    return (
      <AppLayout
        ...
        headerIcon={<i className="fa-solid fa-sliders text-blue-400 text-lg" />}
        headerTitle="Cấu hình Tiêu chí"
        headerSubtitle="Bước 2: Trọng số & Bộ lọc"
        headerRight={<StepIndicator />}
        rightPanel={rightPanel}
        bottomBar={bottomBar}
      >
        {/* ── Page body ──────────────────────────────────────────────────────── */}
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-2 space-y-4">
          {/* Step context banner */}
          <div
