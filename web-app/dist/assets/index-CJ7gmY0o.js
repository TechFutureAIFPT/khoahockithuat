import{M as H,r as w,j as e}from"./index-BvZ4i-tP.js";import{S as f,G as P}from"./index-DPUODRCp.js";const G={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1};let T=null,$=0;const I=[void 0,void 0,void 0,G==null?void 0:G.VITE_GEMINI_API_KEY_4].filter(Boolean);function q(){if(!T){if(I.length===0)throw new Error("No GEMINI_API_KEY environment variables set.");const a=I[$];if(!a)throw new Error("API_KEY environment variable not set.");T=new P(a)}return T}function M(){$=($+1)%I.length,T=null}async function B(a,s,i){for(let r=0;r<I.length;r++)try{return(await q().getGenerativeModel({model:a,generationConfig:i}).generateContent(s)).response}catch(n){console.warn(`API key ${$+1} failed:`,n),M()}throw new Error("All API keys failed. Please check your API keys and quota.")}const R={type:f.OBJECT,properties:{questionSets:{type:f.ARRAY,items:{type:f.OBJECT,properties:{category:{type:f.STRING,description:"Tên danh mục câu hỏi"},icon:{type:f.STRING,description:"Font Awesome icon class"},color:{type:f.STRING,description:"Tailwind color class"},questions:{type:f.ARRAY,items:{type:f.STRING},description:"Danh sách câu hỏi trong danh mục"}},required:["category","icon","color","questions"]}}},required:["questionSets"]},U=async(a,s,i,r)=>{let n="";if(i==="general")n=K(a,s);else if(i==="specific"&&r&&!Array.isArray(r))n=O(a,s,r);else if(i==="comparative"&&Array.isArray(r))n=Y(a,s,r);else throw new Error("Invalid question type or candidate data");try{const h=await B(H,n,{responseMimeType:"application/json",responseSchema:R,temperature:.3,topP:.8,topK:40});return JSON.parse(h.text()).questionSets||[]}catch(h){throw console.error("Error generating interview questions:",h),h}},K=(a,s)=>`
...
`,O=(a,s,i)=>{var b,v,C,x,k;const r=((b=i.analysis)==null?void 0:b["Điểm mạnh CV"])||[],n=((v=i.analysis)==null?void 0:v["Điểm yếu CV"])||[],h=((C=i.analysis)==null?void 0:C["Chi tiết"])||[],g=[],l=[];return h.forEach(u=>{const N=parseFloat(u.Điểm.split("/")[0]),t=parseFloat(u.Điểm.split("/")[1]),o=N/t*100;o>=80?g.push(u["Tiêu chí"]):o<50&&l.push(u["Tiêu chí"])}),`
...
`},Y=(a,s,i)=>{const r=i.map(n=>{var h,g,l,b;return{name:n.candidateName,rank:(h=n.analysis)==null?void 0:h.Hạng,score:(g=n.analysis)==null?void 0:g["Tổng điểm"],title:n.jobTitle,level:n.experienceLevel,strengths:((l=n.analysis)==null?void 0:l["Điểm mạnh CV"])||[],weaknesses:((b=n.analysis)==null?void 0:b["Điểm yếu CV"])||[]}});return`
